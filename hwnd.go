...
func CreateWindowEx(exStyle co.WS_EX, className ClassName, title StrOrNil,
	...
	ret, _, err := syscall.Syscall12(proc2.CreateWindowEx.Addr(), 12,
...
func FindWindow(className ClassName, title StrOrNil) (HWND, bool) {
	classNameVal, classNameBuf := variantClassName(className)
	ret, _, _ := syscall.Syscall(proc2.FindWindow.Addr(), 2,
...
func GetDesktopWindow() HWND {
	ret, _, _ := syscall.Syscall(proc2.GetDesktopWindow.Addr(), 0,
		0, 0, 0)
	return HWND(ret)
}
...
func GetFocus() HWND {
	ret, _, _ := syscall.Syscall(proc2.GetFocus.Addr(), 0,
		0, 0, 0)
	return HWND(ret)
}
...
func GetForegroundWindow() HWND {
	ret, _, _ := syscall.Syscall(proc2.GetForegroundWindow.Addr(), 0,
		0, 0, 0)
	return HWND(ret)
}
...
func GetShellWindow() HWND {
	ret, _, _ := syscall.Syscall(proc2.GetShellWindow.Addr(), 0,
		0, 0, 0)
	return HWND(ret)
}
...
func (hWnd HWND) BeginPaint(ps *PAINTSTRUCT) HDC {
	ret, _, err := syscall.Syscall(proc2.BeginPaint.Addr(), 2,
...
func (hWnd HWND) ChildWindowFromPoint(pt POINT) (HWND, bool) {
	ret, _, _ := syscall.Syscall(proc2.ChildWindowFromPoint.Addr(), 3,
...
func (hWnd HWND) ChildWindowFromPointEx(pt POINT, flags co.CWP) (HWND, bool) {
	ret, _, _ := syscall.Syscall6(proc2.ChildWindowFromPointEx.Addr(), 4,
...
func (hWnd HWND) ClientToScreenPt(pt *POINT) {
	ret, _, err := syscall.Syscall(proc2.ClientToScreen.Addr(), 2,
...
func (hWnd HWND) DefDlgProc(msg co.WM, wParam WPARAM, lParam LPARAM) uintptr {
	ret, _, _ := syscall.Syscall6(proc2.DefDlgProc.Addr(), 4,
...
func (hWnd HWND) DefSubclassProc(
	...
	ret, _, _ := syscall.Syscall6(proc2.DefSubclassProc.Addr(), 4,
		uintptr(hWnd), uintptr(msg), uintptr(wParam), uintptr(lParam),
		0, 0)
	return ret
}
...
func (hWnd HWND) DefWindowProc(
	...
	ret, _, _ := syscall.Syscall6(proc2.DefWindowProc.Addr(), 4,
		uintptr(hWnd), uintptr(msg), uintptr(wParam), uintptr(lParam),
		0, 0)
	return ret
}
...
func (hWnd HWND) DestroyWindow() {
	ret, _, err := syscall.Syscall(proc2.DestroyWindow.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) DragAcceptFiles(accept bool) {
	syscall.Syscall(proc2.DragAcceptFiles.Addr(), 2,
...
func (hWnd HWND) DrawMenuBar() {
	ret, _, err := syscall.Syscall(proc2.DrawMenuBar.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) DwmExtendFrameIntoClientArea(marginsInset *MARGINS) {
	ret, _, _ := syscall.Syscall(proc2.DwmExtendFrameIntoClientArea.Addr(), 2,
...
func (hWnd HWND) DwmSetIconicLivePreviewBitmap(
	...
	ret, _, _ := syscall.Syscall6(proc2.DwmSetIconicLivePreviewBitmap.Addr(), 4,
...
func (hWnd HWND) DwmSetIconicThumbnail(hBmp HBITMAP, sitFlags co.DWM_SIT) {
	ret, _, _ := syscall.Syscall(proc2.DwmSetIconicThumbnail.Addr(), 3,
...
func (hWnd HWND) EnableWindow(enable bool) bool {
	ret, _, _ := syscall.Syscall(proc2.EnableWindow.Addr(), 2,
...
func (hWnd HWND) EndDialog(result uintptr) {
	ret, _, err := syscall.Syscall(proc2.EndDialog.Addr(), 2,
...
func (hWnd HWND) EndPaint(ps *PAINTSTRUCT) {
	syscall.Syscall(proc2.EndPaint.Addr(), 2,
		uintptr(hWnd), uintptr(unsafe.Pointer(ps)), 0)
}
...
func (hWnd HWND) EnumChildWindows(enumFunc func(hChild HWND) bool) {
	...
	syscall.Syscall(proc2.EnumChildWindows.Addr(), 3,
...
func (hWnd HWND) GetAncestor(gaFlags co.GA) HWND {
	ret, _, _ := syscall.Syscall(proc2.GetAncestor.Addr(), 2,
...
func (hWnd HWND) GetClassLongPtr(index co.GCL) uint32 {
	ret, _, err := syscall.Syscall(proc2.GetClassLongPtr.Addr(), 2,
...
func (hWnd HWND) GetClassName() string {
	...
	ret, _, err := syscall.Syscall(proc2.GetClassName.Addr(), 3,
...
func (hWnd HWND) GetClientRect() RECT {
	var rc RECT
	ret, _, err := syscall.Syscall(proc2.GetClientRect.Addr(), 2,
		uintptr(hWnd), uintptr(unsafe.Pointer(&rc)), 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) GetDC() HDC {
	ret, _, err := syscall.Syscall(proc2.GetDC.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) GetDlgCtrlID() int32 {
	ret, _, err := syscall.Syscall(proc2.GetDlgCtrlID.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) GetDlgItem(dlgId int32) HWND {
	ret, _, err := syscall.Syscall(proc2.GetDlgItem.Addr(), 2,
...
func (hWnd HWND) GetMenu() HMENU {
	ret, _, _ := syscall.Syscall(proc2.GetMenu.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return HMENU(ret)
}
...
func (hWnd HWND) GetNextDlgGroupItem(hChild HWND, isPrevious bool) HWND {
	ret, _, err := syscall.Syscall(proc2.GetNextDlgGroupItem.Addr(), 3,
...
func (hWnd HWND) GetNextDlgTabItem(hChild HWND, isPrevious bool) HWND {
	ret, _, err := syscall.Syscall(proc2.GetNextDlgTabItem.Addr(), 3,
		uintptr(hWnd), uintptr(hChild), util.BoolToUintptr(isPrevious))
	if wErr := errco.ERROR(err); ret == 0 && wErr != errco.SUCCESS {
		panic(wErr)
	}
...
func (hWnd HWND) GetParent() HWND {
	ret, _, err := syscall.Syscall(proc2.GetParent.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if wErr := errco.ERROR(err); ret == 0 && wErr != errco.SUCCESS {
		panic(wErr)
	}
...
func (hWnd HWND) GetScrollInfo(bar co.SB_TYPE, si *SCROLLINFO) {
	ret, _, err := syscall.Syscall(proc2.GetScrollInfo.Addr(), 3,
...
func (hWnd HWND) GetSystemMenu(revert bool) HMENU {
	ret, _, _ := syscall.Syscall(proc2.GetSystemMenu.Addr(), 2,
...
func (hWnd HWND) GetTopWindow() HWND {
	ret, _, err := syscall.Syscall(proc2.GetTopWindow.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if wErr := errco.ERROR(err); ret == 0 && wErr != errco.SUCCESS {
		panic(wErr)
	}
...
func (hWnd HWND) GetWindow(cmd co.GW) HWND {
	ret, _, err := syscall.Syscall(proc2.GetWindow.Addr(), 2,
...
func (hWnd HWND) GetWindowDC() HDC {
	ret, _, err := syscall.Syscall(proc2.GetWindowDC.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) GetWindowLongPtr(index co.GWLP) uintptr {
	ret, _, err := syscall.Syscall(proc2.GetWindowLongPtr.Addr(), 2,
		uintptr(hWnd), uintptr(index), 0)
	if wErr := errco.ERROR(err); ret == 0 && wErr != errco.SUCCESS {
		panic(wErr)
	}
...
func (hWnd HWND) GetWindowRect() RECT {
	var rc RECT
	ret, _, err := syscall.Syscall(proc2.GetWindowRect.Addr(), 2,
		uintptr(hWnd), uintptr(unsafe.Pointer(&rc)), 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) GetWindowText() string {
	...
	ret, _, err := syscall.Syscall(proc2.GetWindowText.Addr(), 3,
...
func (hWnd HWND) GetWindowTextLength() int32 {
	ret, _, _ := syscall.Syscall(proc2.GetWindowTextLength.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return int32(ret)
}
...
func (hWnd HWND) HideCaret() {
	ret, _, err := syscall.Syscall(proc2.HideCaret.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) HiliteMenuItem(hMenu HMENU, item MenuItem, hilite bool) bool {
	...
	ret, _, _ := syscall.Syscall6(proc2.HiliteMenuItem.Addr(), 4,
...
func (hWnd HWND) InvalidateRect(rc *RECT, erase bool) {
	ret, _, err := syscall.Syscall(proc2.InvalidateRect.Addr(), 3,
...
func (hWnd HWND) IsChild(hChild HWND) bool {
	ret, _, _ := syscall.Syscall(proc2.IsChild.Addr(), 2,
...
func (hWnd HWND) IsDlgButtonChecked(idButton int32) co.BST {
	ret, _, _ := syscall.Syscall(proc2.IsDlgButtonChecked.Addr(), 2,
...
func (hWnd HWND) IsDialogMessage(msg *MSG) bool {
	ret, _, _ := syscall.Syscall(proc2.IsDialogMessage.Addr(), 2,
...
func (hWnd HWND) IsIconic() bool {
	ret, _, _ := syscall.Syscall(proc2.IsIconic.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
...
func (hWnd HWND) IsThemeDialogTextureEnabled() bool {
	ret, _, _ := syscall.Syscall(proc2.IsThemeDialogTextureEnabled.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
...
func (hWnd HWND) IsWindow() bool {
	ret, _, _ := syscall.Syscall(proc2.IsWindow.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
...
func (hWnd HWND) IsWindowEnabled() bool {
	ret, _, _ := syscall.Syscall(proc2.IsWindowEnabled.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
...
func (hWnd HWND) IsWindowVisible() bool {
	ret, _, _ := syscall.Syscall(proc2.IsWindowVisible.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
...
func (hWnd HWND) IsZoomed() bool {
	ret, _, _ := syscall.Syscall(proc2.IsZoomed.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
...
func (hWnd HWND) KillTimer(id uintptr) {
	ret, _, err := syscall.Syscall(proc2.KillTimer.Addr(), 2,
		uintptr(hWnd), id, 0)
...
func (hWnd HWND) LogicalToPhysicalPoint(pt *POINT) {
	ret, _, err := syscall.Syscall(proc2.LogicalToPhysicalPoint.Addr(), 2,
		uintptr(hWnd), uintptr(unsafe.Pointer(pt)), 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) MapDialogRect(rc *RECT) {
	ret, _, err := syscall.Syscall(proc2.MapDialogRect.Addr(), 2,
		uintptr(hWnd), uintptr(unsafe.Pointer(rc)), 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) MenuItemFromPoint(hMenu HMENU, pt POINT) (int, bool) {
	ret, _, _ := syscall.Syscall6(proc2.MenuItemFromPoint.Addr(), 4,
...
func (hWnd HWND) MessageBox(text, caption string, uType co.MB) co.ID {
	ret, _, err := syscall.Syscall6(proc2.MessageBox.Addr(), 4,
...
func (hWnd HWND) MonitorFromWindow(flags co.MONITOR) HMONITOR {
	ret, _, _ := syscall.Syscall(proc2.MonitorFromWindow.Addr(), 2,
...
func (hWnd HWND) MoveWindow(x, y, width, height int32, repaint bool) {
	ret, _, err := syscall.Syscall6(proc2.MoveWindow.Addr(), 6,
...
func (hWnd HWND) OpenClipboard() HCLIPBOARD {
	ret, _, err := syscall.Syscall(proc2.OpenClipboard.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) OpenThemeData(classNames string) (HTHEME, error) {
	ret, _, err := syscall.Syscall(proc2.OpenThemeData.Addr(), 2,
...
func (hWnd HWND) PostMessage(msg co.WM, wParam WPARAM, lParam LPARAM) {
	ret, _, err := syscall.Syscall6(proc2.PostMessage.Addr(), 4,
		uintptr(hWnd), uintptr(msg), uintptr(wParam), uintptr(lParam),
		0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
...
func (hWnd HWND) ReleaseDC(hdc HDC) {
	ret, _, err := syscall.Syscall(proc2.ReleaseDC.Addr(), 2,
...
func (hWnd HWND) RemoveWindowSubclass(
	...
	ret, _, err := syscall.Syscall(proc2.RemoveWindowSubclass.Addr(), 3,
...
func (hWnd HWND) ScreenToClientPt(pt *POINT) {
	ret, _, err := syscall.Syscall(proc2.ScreenToClient.Addr(), 2,
		uintptr(hWnd), uintptr(unsafe.Pointer(pt)), 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) SendMessage(msg co.WM, wParam WPARAM, lParam LPARAM) uintptr {
	ret, _, _ := syscall.Syscall6(proc2.SendMessage.Addr(), 4,
		uintptr(hWnd), uintptr(msg), uintptr(wParam), uintptr(lParam),
		0, 0)
	return ret
}
...
func (hWnd HWND) SetFocus() (HWND, error) {
	ret, _, err := syscall.Syscall(proc2.SetFocus.Addr(), 1,
		uintptr(hWnd), 0, 0)
...
func (hWnd HWND) SetForegroundWindow() bool {
	ret, _, _ := syscall.Syscall(proc2.SetForegroundWindow.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
...
func (hWnd HWND) SetParent(hwndNewParent HWND) HWND {
	ret, _, err := syscall.Syscall(proc2.SetParent.Addr(), 2,
...
func (hWnd HWND) SetMenu(hMenu HMENU) {
	ret, _, err := syscall.Syscall(proc2.SetMenu.Addr(), 2,
...
func (hWnd HWND) SetScrollInfo(
	...
	ret, _, _ := syscall.Syscall6(proc2.SetScrollInfo.Addr(), 4,
		uintptr(hWnd), uintptr(bar), uintptr(unsafe.Pointer(si)),
...
func (hWnd HWND) SetTimer(msElapse uint32, id uintptr) uintptr {
	ret, _, err := syscall.Syscall6(proc2.SetTimer.Addr(), 4,
...
func (hWnd HWND) SetWindowLongPtr(index co.GWLP, newLong uintptr) uintptr {
	syscall.Syscall(proc2.SetLastError.Addr(), 0,
		0, 0, 0)

	ret, _, err := syscall.Syscall(proc2.SetWindowLongPtr.Addr(), 3,
...
func (hWnd HWND) SetWindowPos(
	...
	ret, _, err := syscall.Syscall9(proc2.SetWindowPos.Addr(), 7,
...
func (hWnd HWND) SetWindowSubclass(
	...
	ret, _, err := syscall.Syscall6(proc2.SetWindowSubclass.Addr(), 4,
...
func (hWnd HWND) SetWindowText(text string) {
	syscall.Syscall(proc2.SetWindowText.Addr(), 2,
		uintptr(hWnd), uintptr(unsafe.Pointer(Str.ToNativePtr(text))),
		0)
}
...
func (hWnd HWND) ShowCaret() {
	ret, _, err := syscall.Syscall(proc2.ShowCaret.Addr(), 1,
		uintptr(hWnd), 0, 0)
	if ret == 0 {
		panic(errco.ERROR(err))
	}
...
func (hWnd HWND) ShowWindow(cmdShow co.SW) bool {
	ret, _, _ := syscall.Syscall(proc2.ShowWindow.Addr(), 1,
...
func (hWnd HWND) TaskDialog(
	...
	var pnButton int32
	ret, _, _ := syscall.Syscall9(proc2.TaskDialog.Addr(), 8,
...
func (hWnd HWND) TranslateAccelerator(hAccel HACCEL, msg *MSG) error {
	ret, _, err := syscall.Syscall(proc2.TranslateAccelerator.Addr(), 3,
...
func (hWnd HWND) UpdateWindow() bool {
	ret, _, _ := syscall.Syscall(proc2.UpdateWindow.Addr(), 1,
		uintptr(hWnd), 0, 0)
	return ret != 0
}
