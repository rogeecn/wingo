...
func SystemTimeToTzSpecificLocalTime(
	...
	ret, _, err := syscall.Syscall(proc2.SystemTimeToTzSpecificLocalTime.Addr(), 3,
...
func TaskDialogIndirect(taskConfig *TASKDIALOGCONFIG) co.ID {
	...
	var pnButton co.ID
	ret, _, _ := syscall.Syscall6(proc2.TaskDialogIndirect.Addr(), 4,
...
func TranslateMessage(msg *MSG) bool {
	ret, _, _ := syscall.Syscall(proc2.TranslateMessage.Addr(), 1,
		uintptr(unsafe.Pointer(msg)), 0, 0)
	return ret != 0
}
...
func TzSpecificLocalTimeToSystemTime(
	...
	ret, _, err := syscall.Syscall(proc2.TzSpecificLocalTimeToSystemTime.Addr(), 3,
		uintptr(unsafe.Pointer(timeZoneInfo)),
...
func VerQueryValue(
	...
	var puLen uint32
	ret, _, _ := syscall.Syscall6(proc2.VerQueryValue.Addr(), 4,
...
func VerifyVersionInfo(
	...
	ret, _, err := syscall.Syscall(proc2.VerifyVersionInfo.Addr(), 3,
...
func VerSetConditionMask(
	...
	ret, _, _ := syscall.Syscall(proc2.VerSetConditionMask.Addr(), 3,
